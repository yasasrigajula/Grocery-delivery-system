(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "GROCERIES-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.currency = "rupees"; // HTML entity of the currency to be displayed in the layout
